            ...
            <Text textAlign="justify" style={{ lineHeight: 2 }}>
                ...
                <ol>
                    <li>
                        ...
                        serta surat pernyataan dari yang bersangkutan
                        pekerjaannya adalah {datas.penduduk.job.name} dengan
                        penghasilan rata-rata perbulan {datas.penghasilan}.
                    </li>
                    <li>
...
export default PenghasilanTemplate;
